...
// QuickSort Functions
// ==========================================================================
// Switch first_index and second_index together
void HighScore::Swap(vector<HighScore> *list, int first_index, int second_index)
{
...
// Check Section Of The vector
int HighScore::Partition(vector<HighScore> *list, int first_index, int last_index)
{
...
// Split vector into different setion for checking
void HighScore::QuickSort(vector<HighScore> *list, int first_index, int last_index)
{
...
{
	os << input.Data.rank << ' ' << input.Data.name << ' ' << input.Data.score << std::endl;
	return os;
}